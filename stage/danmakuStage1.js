'use strict';
     localStorage.setItem('zanki', 5);
   var timer = document.getElementById('timer');
    var start = document.getElementById('start');
    var hp = document.getElementById('hp');
    var bom = document.getElementById('bom');
    var zankis = document.getElementById('zankis');
...
class DanmakuStgEndScene extends Scene {
    constructor(renderingTarget) {
       ...
       const text = new TextLabel(125, 400, 'ステージ１クリア！');
        this.add(text);
        location.href = 'Stage2.html?fighterZanki='+encodeURIComponent(zanki);
